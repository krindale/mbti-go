  ...
  static List<MBTIType> getAllTypes() {
    return [
      ...
      MBTIType(
        ...
        detailedDescription:
            '''당신은 끝없는 호기심을 가진 '탐구가'입니다. 마치 매드 사이언티스트처럼, 당신의 마음은 항상 새로운 아이디어와 가능성들로 가득 차 있습니다. 복잡한 문제를 단순하고 우아한 해결책으로 바꿔내는 당신의 능력은 정말 마술과 같습니다. 때로는 구름 위를 걷는 것 같지만, 그 자유로운 사고가 세상을 바꿀 혁신적인 발견으로 이어지는 진정한 지식의 탐험가입니다.''',
      ),
      MBTIType(
        code: 'ENTJ',
        name: '지휘관',
        ...
        detailedDescription:
            '''당신은 천생 리더인 '지휘관'입니다. 마치 전장의 장군처럼, 복잡한 상황 속에서도 명확한 전략과 비전을 제시하며 팀을 이끌어갑니다. 당신의 카리스마와 추진력은 불가능해 보이는 목표도 현실로 만들어내는 힘을 가지고 있습니다. 때로는 너무 강한 드라이브로 인해 오해받기도 하지만, 그 열정이 조직과 사회를 발전시키는 진정한 변화의 촉매제입니다.''',
      ),
      MBTIType(
        code: 'ENTP',
        name: '혁신가',
        ...
        detailedDescription:
            '''당신은 아이디어의 연금술사인 '혁신가'입니다. 마치 스파크가 튀는 브레인스토밍 세션처럼, 당신의 주위에는 항상 창의적인 에너지가 넘쳐흐릅니다. 기존의 틀을 깨뜨리고 새로운 관점을 제시하는 당신의 능력은 주변 사람들에게 영감을 줍니다. 때로는 너무 많은 아이디어로 인해 산만해 보일 수 있지만, 그 다채로운 사고가 세상에 혁신을 가져다주는 진정한 아이디어 제너레이터입니다.''',
      ),
      ...
      MBTIType(
        ...
        detailedDescription:
            '''당신은 순수한 마음을 가진 '몽상가'입니다. 마치 시인의 감성으로 세상을 바라보며, 모든 것에서 아름다움과 의미를 찾아냅니다. 당신의 깊은 공감 능력과 따뜻한 마음은 상처받은 이들에게 안식처가 되어줍니다. 때로는 현실과 이상 사이에서 고민하기도 하지만, 그 순수한 열정이 세상에 평화와 조화를 가져다주는 진정한 마음의 예술가입니다.''',
      ),
      MBTIType(
        code: 'ENFJ',
        name: '멘토',
        ...
        detailedDescription:
            '''당신은 따뜻한 카리스마를 가진 '멘토'입니다. 마치 태양처럼, 당신의 존재만으로도 주변 사람들이 밝아지고 용기를 얻습니다. 다른 이들의 잠재력을 알아보고 그들이 성장할 수 있도록 돕는 당신의 능력은 정말 특별합니다. 때로는 남을 위해 자신을 희생하기도 하지만, 그 무조건적인 사랑과 지지가 많은 이들의 인생을 바꿔놓는 진정한 인간관계의 마에스트로입니다.''',
      ),
      MBTIType(
        code: 'ENFP',
        name: '활동가',
      ...
      MBTIType(
        ...
        detailedDescription:
            '''당신은 사람들을 하나로 묶는 '협력자'입니다. 마치 따뜻한 커뮤니티 센터처럼, 당신 주위에는 항상 사람들이 모이고 웃음꽃이 핍니다. 다른 이들의 감정을 세심하게 배려하고 조화로운 분위기를 만드는 당신의 능력은 정말 특별합니다. 때로는 남들의 평가에 너무 신경써서 힘들 수 있지만, 그 따뜻한 마음과 배려가 많은 이들에게 소속감과 행복을 선사하는 진정한 관계의 아키텍트입니다.''',
      ),
      ...
      MBTIType(
        ...
        detailedDescription:
            '''당신은 손재주가 뛰어난 '해결사'입니다. 마치 마법사의 손처럼, 복잡한 기계나 도구들이 당신의 손을 거치면 완벽하게 작동합니다. 차분하고 과묵해 보이지만, 실제로는 끊임없이 세상의 원리를 탐구하고 실험하는 호기심 많은 탐험가입니다. 때로는 말보다 행동으로 표현하는 성향 때문에 오해받기도 하지만, 그 실용적인 지혜와 문제해결 능력이 위기의 순간에 빛을 발하는 진정한 솔루션 크리에이터입니다.''',
      ),
      MBTIType(
        code: 'ISFP',
        name: '모험가',
      ...
      MBTIType(
        ...
        detailedDescription:
            '''당신은 현장의 스타인 '도전가'입니다. 마치 무대 위의 연기자처럼, 어떤 상황에서도 자신감 넘치는 모습으로 사람들을 매료시킵니다. 순간의 기회를 놓치지 않고 과감하게 도전하는 당신의 모습은 정말 역동적입니다. 때로는 너무 즉흥적이어서 계획성이 부족해 보일 수 있지만, 그 뛰어난 순발력과 적응력이 예상치 못한 성공을 만들어내는 진정한 기회의 사냥꾼입니다.''',
      ),
      MBTIType(
        code: 'ESFP',
        name: '연예인',
