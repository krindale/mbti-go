  ...
  static List<MBTIType> getAllTypes() {
    return [
      ...
      MBTIType(
        ...
        name: '전략가',
        category: 'NT',
        description: '상상력이 풍부하고 전략적인 사상가로,\n모든 일에 계획을 세웁니다.',
        ...
        detailedDescription:
            '''당신은 진정한 '전략가'입니다. 마치 거대한 도서관의 사서처럼, 당신의 마음속에는 수많은 지식과 아이디어들이 체계적으로 정리되어 있습니다. 당신의 전략적 사고와 장기적 비전은 복잡한 문제들을 혁신적인 해결책으로 바꿔내는 마법과 같습니다. 때로는 외로운 길을 걸어도, 당신만의 완벽한 설계도를 그리며 미래를 건설해나가는 진정한 마스터플랜의 창조자입니다.''',
      ),
      MBTIType(
        code: 'INTP',
        name: '탐구가',
        category: 'NT',
        description: '혁신적인 발명가로, 지식에 대한\n끝없는 갈증을 가지고 있습니다.',
        ...
        detailedDescription:
            '''당신은 진정한 '탐구가'입니다. 마치 중세의 연금술사처럼, 복잡한 정보들을 순수한 논리와 통찰로 변환시키는 마법 같은 능력을 가지고 있습니다. 끝없는 호기심과 "만약에..."라는 가능성 사고로 새로운 세상을 탐험하는 지식의 개척자입니다. 당신의 실험실에서는 아이디어들이 서로 충돌하고 융합하며, 세상이 미처 발견하지 못한 새로운 진리를 탄생시킵니다.''',
      ),
      MBTIType(
        code: 'ENTJ',
        name: '지휘관',
        category: 'NT',
        description: '대담하고 상상력이 풍부한\n강력한 의지의 리더입니다.',
        ...
        detailedDescription:
            '''당신은 타고난 '지휘관'입니다. 마치 체스의 퀸처럼, 전략적이면서도 공격적으로 목표를 향해 나아가는 당신의 모습은 주변 사람들에게 강한 인상을 남깁니다. 당신의 눈에는 항상 더 큰 그림이 보이고, 그 비전을 현실로 만들어내는 실행력이 당신을 진정한 리더로 만듭니다. 어떤 장애물이 와도 굴복하지 않는 강인한 의지와 카리스마로, 불가능해 보이는 일들을 가능하게 만드는 기적의 지휘관입니다.''',
      ),
      MBTIType(
        code: 'ENTP',
        name: '혁신가',
        category: 'NT',
        description: '영리하고 호기심이 많은 사상가로,\n지적 도전을 거부할 수 없습니다.',
        ...
        detailedDescription:
            '''당신은 창의적인 '혁신가'입니다. 마치 지적 호기심으로 가득 찬 탐험가처럼, 새로운 아이디어의 세계를 끊임없이 탐험합니다. 당신의 머릿속에서는 언제나 혁신적인 연결고리들이 만들어지고, 그 독창적 사고가 세상에 새로운 가능성을 제시합니다. 논쟁을 두려워하지 않고 진실을 추구하는 당신은, 기존의 틀을 깨뜨리고 새로운 패러다임을 제시하는 혁신의 선구자입니다.''',
      ),
      ...
      MBTIType(
        ...
        name: '몽상가',
        category: 'NF',
        description: '시적이고 친절하며 이타적인 사람으로,\n언제나 선의와 화합을 추구합니다.',
        ...
        detailedDescription:
            '''당신은 따뜻한 '몽상가'입니다. 마치 아름다운 정원을 가꾸는 원예가처럼, 당신은 자신만의 가치관이라는 씨앗을 정성스럽게 키워갑니다. 다른 사람들이 보지 못하는 아름다움을 발견하고, 그 순수한 마음으로 세상에 따뜻함과 진정성을 전파하는 당신은 진정한 예술가입니다. 갈등 상황에서도 모든 사람의 마음을 이해하려 노력하며, 조화와 평화를 만들어가는 진정한 중재의 달인입니다.''',
      ),
      MBTIType(
        code: 'ENFJ',
        name: '멘토',
        category: 'NF',
        description: '카리스마 있고 영감을 주는 리더로,\n청중을 매혹시키는 능력이 있습니다.',
        ...
        detailedDescription:
            '''당신은 카리스마 넘치는 '멘토'입니다. 마치 따뜻한 햇살처럼 주변 사람들을 비추며, 그들 안에 숨어있는 잠재력을 깨우는 마법 같은 능력을 가지고 있습니다. 당신의 진심 어린 관심과 격려는 다른 사람들로 하여금 자신도 몰랐던 가능성을 발견하게 만드는 선물입니다. 때로는 다른 사람을 위해 자신을 희생하기도 하지만, 그 이타적 마음이야말로 진정한 리더십의 본질입니다.''',
      ),
      MBTIType(
        code: 'ENFP',
        name: '활동가',
        category: 'NF',
        description: '열정적이고 창의적인 사교적인 자유로운\n영혼으로, 언제나 웃을 이유를 찾을 수\n있습니다.',
      ...
      MBTIType(
        ...
        name: '수호자',
        category: 'SJ',
        description: '매우 헌신적이고 따뜻한 수호자로,\n언제나 사랑하는 사람들을 방어할 준비가\n되어 있습니다.',
      ...
      MBTIType(
        ...
        name: '협력자',
        category: 'SJ',
        description: '매우 배려심이 많고 사교적이며 인기가 많은\n사람으로, 언제나 도움을 주려 합니다.',
        ...
        detailedDescription:
            '''당신은 사교적인 '협력자'입니다. 마치 따뜻한 카페의 바리스타처럼, 사람들이 모이는 곳에는 항상 당신이 있습니다. 당신의 진심 어린 관심과 배려는 서로 다른 사람들을 하나로 연결하며, 모든 이가 소속감을 느낄 수 있는 공동체를 만드는 특별한 재능입니다. 전통과 조화를 중시하는 당신은 갈등을 해결하고 평화를 만들어가는 천성적인 몽상가이자 사회의 접착제 역할을 합니다.''',
      ),
      ...
      MBTIType(
        ...
        name: '해결사',
        category: 'SP',
        description: '대담하고 실용적인 실험정신이 풍부한\n장인으로, 모든 종류의 도구를 자유자재로\n다룹니다.',
        ...
        detailedDescription:
            '''당신은 실용적인 '해결사'입니다. 마치 숙련된 장인처럼, 당신의 손에 닿는 모든 것들이 완벽하게 동작하게 됩니다. 복잡한 문제 앞에서도 침착함을 잃지 않고, 직관적이면서도 효율적인 해결책을 찾아내는 당신은 진정한 문제 해결의 달인입니다. 말보다는 행동으로, 이론보다는 실습으로 세상과 소통하는 당신은 실무의 철학자이자 현실의 마술사입니다.''',
      ),
      MBTIType(
        code: 'ISFP',
        name: '모험가',
        category: 'SP',
        description: '유연하고 매력적인 예술가로, 언제나 새로운\n가능성을 탐험할 준비가 되어 있습니다.',
      ...
      MBTIType(
        ...
        name: '도전가',
        category: 'SP',
        description: '영리하고 에너지 넘치며 인식력이 뛰어난\n사람으로, 진정으로 위험을 즐깁니다.',
        ...
        detailedDescription:
            '''당신은 역동적인 '도전가'입니다. 마치 스포츠카처럼 빠르고 민첩한 당신은, 기회의 순간을 놓치지 않고 즉시 행동으로 옮기는 타고난 실행력을 가지고 있습니다. 당신의 생동감 넘치는 에너지와 현실적 감각은 주변 사람들을 활기차게 만들며, 모든 순간을 흥미진진하게 바꿉니다. 위험을 두려워하지 않고 도전하는 용기로, 정적인 일상에 활력과 변화를 불어넣는 진정한 액션의 주인공입니다.''',
      ),
      MBTIType(
        code: 'ESFP',
        name: '연예인',
        category: 'SP',
        description: '자발적이고 에너지 넘치며 열정적인\n연예인으로, 주변 사람들을 지루하게\n하는 일은 절대 없습니다.',
