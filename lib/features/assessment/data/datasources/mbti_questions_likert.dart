...
class MBTIQuestionsLikert {
  ...
  static List<Question> getQuickAssessmentQuestions() {
    return [
      ...
      Question(
        id: 7,
        text: '일을 계획할 때 단계별로 세부적인 계획을 세우는 편이다',
        dimension: QuestionDimension.sn,
        options: [
          QuestionOption(text: '전혀 그렇지 않다', score: -2.0, value: 1),
          QuestionOption(text: '그렇지 않다', score: -1.0, value: 2),
      ...
      Question(
        id: 8,
        text: '새로운 아이디어를 들으면 가능성과 잠재력에 더 흥미를 느낀다',
        dimension: QuestionDimension.sn,
        isReversed: true,
        options: [
          QuestionOption(text: '전혀 그렇지 않다', score: 2.0, value: 1),
      ...
      Question(
        id: 9,
        text: '과거의 경험과 현재의 현실에 더 집중하는 편이다',
        dimension: QuestionDimension.sn,
        options: [
          QuestionOption(text: '전혀 그렇지 않다', score: -2.0, value: 1),
          QuestionOption(text: '그렇지 않다', score: -1.0, value: 2),
      ...
      Question(
        id: 11,
        text: '결정을 내릴 때 논리적 분석과 객관적 사실을 더 중요하게 생각한다',
      ...
      Question(
        id: 12,
        text: '갈등 상황에서 원칙과 규칙에 따라 해결하려고 한다',
        dimension: QuestionDimension.tf,
        options: [
          QuestionOption(text: '전혀 그렇지 않다', score: -2.0, value: 1),
          QuestionOption(text: '그렇지 않다', score: -1.0, value: 2),
      ...
      Question(
        id: 13,
        text: '비판을 받을 때 논리적으로 맞는지를 먼저 분석한다',
        dimension: QuestionDimension.tf,
        options: [
          QuestionOption(text: '전혀 그렇지 않다', score: -2.0, value: 1),
          QuestionOption(text: '그렇지 않다', score: -1.0, value: 2),
      ...
      Question(
        id: 14,
        text: '다른 사람을 평가할 때 능력과 성과를 더 중요하게 본다',
        dimension: QuestionDimension.tf,
        options: [
          QuestionOption(text: '전혀 그렇지 않다', score: -2.0, value: 1),
          QuestionOption(text: '그렇지 않다', score: -1.0, value: 2),
      ...
      Question(
        id: 15,
        text: '팀 프로젝트에서 효율성을 높이고 목표 달성에 집중한다',
        dimension: QuestionDimension.tf,
        options: [
          QuestionOption(text: '전혀 그렇지 않다', score: -2.0, value: 1),
          QuestionOption(text: '그렇지 않다', score: -1.0, value: 2),
      ...
      Question(
        id: 16,
        text: '여행을 계획할 때 미리 세세한 일정을 계획하는 편이다',
      ...
      Question(
        id: 17,
        text: '데드라인이 있는 일은 미리 미리 준비해서 여유있게 마무리한다',
        dimension: QuestionDimension.jp,
        options: [
          QuestionOption(text: '전혀 그렇지 않다', score: -2.0, value: 1),
          QuestionOption(text: '그렇지 않다', score: -1.0, value: 2),
      ...
      Question(
        id: 20,
        text: '새로운 기회가 왔을 때 신중하게 검토한 후 결정한다',
        dimension: QuestionDimension.jp,
        options: [
          QuestionOption(text: '전혀 그렇지 않다', score: -2.0, value: 1),
          QuestionOption(text: '그렇지 않다', score: -1.0, value: 2),
